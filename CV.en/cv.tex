...
\NewEntry{2013-2016}{Logic}{University of Leipzig}
...
{Thesis: \textit{The Lambda Calculus as a paradigmatic Concept of Computatbility}\newline
...
\NewEntry{2008-2013}{Mechanical Engineering}{RFH Köln}

\Description{\MarginText{Bachelor of Engineering\\(Grade Point Average: 1.8)}%
Specialization:
\EvenThree%
    {\isym\ \textit{Technical Optics / Laser Technology}}%
    {\isym\ \textit{Mechatronics}}%
    {\isym\ \textit{Programming in C}}%
Thesis (Grade 1.0): \textit{Wear Detection of Cutting Tools in Tunneling}\newline
...
\Description{\MarginText{Very Good} Haskell, Prolog, SMT-Lib}

\Description{\MarginText{Good} Java, C, MATLAB, Simulink, OCaml}

\Description{\MarginText{Basics} Scala, SQL, JavaScript/ECMAScript, HTML, CSS, C++, Bash}
