...
\isym\ Recherche für den maschinellen Tunnelvortrieb bei Atomendlagern\newline
...
dieses Kalkül ist unter anderem Zielsprache für Compiler funktionaler Sprachen, 
sowie Zwischensprache für die Übersetzung 
funktionaler Programme auf die Von-Neumann-Architektur.
}
...
\NewEntry{Funktionale Programmierung}{Haskell}{\href{https://github.com/julmue/LambdaTypeCheckers}{Projektseite}}

\Description{\MarginText{Type-Checker}%
Type-Checker für das verschiedene typisierte Lambdakalküle. 
Diese Kalküle sind das theoretische Fundament statisch typisierte funktionaler
...
\Description{\MarginText{Sehr gut} Haskell, Prolog, SMT-Lib}

\Description{\MarginText{Gut} Java, C, MATLAB, Simulink, OCaml}

\Description{\MarginText{Grundlagen} Scala, SQL, JavaScript/ECMAScript, HTML, CSS, C++, Bash}
...
\Description{\MarginText{Sehr gut}Englisch (verhandlungssicher)}
